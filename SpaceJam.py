...
class SpaceJam(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Planet1.setPos(600, 500, 2500)
        ...
        self.Planet2.setPos(2000, 1000, 2200)
        ...
        self.Planet3.setPos(400, 2000, 2800)
        ...
        self.Planet4.setPos(200, 1450, 400)
        ...
        self.Planet5.setPos(1500, 2200, 1500)
        ...
        self.Planet6.setPos(1500, 200, 11000)
        ...
        self.Ship1.setPos(100, 4280, 100)
        ...
        self.Station1.setPos(110, 2300, 1120)
